...
\begin{lstlisting}
$ wget https://github.com/NiharikaKute/PINGALA/blob/main/codes/1.py
\end{lstlisting}
and run it using
\begin{lstlisting}
$ python3 1.py
...
Download the Python code using
\begin{lstlisting}
$ wget https://github.com/NiharikaKute/PINGALA/blob/main/codes/2_1.py
\end{lstlisting}
and run it using
\begin{lstlisting}
$ python3 2_1.py
...
\begin{figure}[!htp]
    \includegraphics[width=\columnwidth]{/Users/niharika/Desktop/Pingala/figures/2_1.pdf}
    \caption{Plot of $x(n)$}
    \label{fig:xn}
\end{figure}
...
Download the Python code using
\begin{lstlisting}
$ wget https://github.com/NiharikaKute/PINGALA/blob/main/codes/2_2.py
\end{lstlisting}
and run it using
\begin{lstlisting}
$ python3 2_2.py
...
\begin{figure}[!htbp]
    \includegraphics[width=\columnwidth]{/Users/niharika/Desktop/Pingala/figures/2_2.pdf}
    \caption{Plot of $y(n)$}
    \label{fig:yn}
\end{figure}
\item Find $Y^{+}(z)$. 
